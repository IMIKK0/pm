...
<body class="ContentBody">
  <form action="${pageContext.request.contextPath }/eaaAction_addEaa" method="post" enctype="multipart/form-data" name="form" target="mainFrame" >
			...
			<TD width="100%">
				...
				<legend>审批信息</legend>
					  ...
					  <tr>
					    ...
					    <td><input class="text" type="Date" name="eaa.eaa_time" style="width:154px" value=""/></td>
					    <td align="right">审批状态:</td>
					    <td><input class="text" name='eaa.eaa_state' style="width:154px" value=""/></td>
					  </tr>
					 
					  <tr>
					    <td align="right">描述:</td>
					    <td colspan="3"><textarea name="eaa.eaa_content" cols="100" rows="8" value=""></textarea></td>
					    </tr>
					  </table>
			  <br />
				</fieldset>			</TD>
